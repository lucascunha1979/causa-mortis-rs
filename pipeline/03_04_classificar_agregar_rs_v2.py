# -*- coding: utf-8 -*-
"""Classifica (CID-10) e agrega os microdados do RS nas tabelas do painel. v2

v2: CODMUNRES 4314530 (2001-2002) é o código histórico de Pinto Bandeira, hoje 4314548 (IBGE); os 37
registros passam a contar em 431454 em vez de ficarem só no total do RS.
...
CODIGOS_HISTORICOS = {"431453": "431454"}   # Pinto Bandeira: código de 2001-2002 -> código atual
...
def main(anos):
    ...
    for ano in anos:
        ...
        d["mun"] = d.CODMUNRES.str.strip().str[:6].replace(CODIGOS_HISTORICOS)
